...
define([
    ...
    var oauth2ContextPath = "oauth2",
        uriContextParts = Constants.context.split("/"),
        uriContext = uriContextParts.slice(0, uriContextParts.indexOf(oauth2ContextPath)),
        obj = new AbstractDelegate(Constants.host + "/" + uriContext + "/json/"),
    ...
    obj.getUserSessionId = function () {
        ServiceInvoker.updateConfigurationCallback({});
        return getConfiguration().then(function (config) {
